...
| ---------- |:-----:| ----------- |
| [tensorflow](https://github.com/tensorflow/tensorflow) | 165513 | An Open Source Machine Learning Framework for Everyone |
| [pytorch](https://github.com/pytorch/pytorch) | 56510 | Tensors and Dynamic neural networks in Python with strong GPU acceleration |
| [keras](https://github.com/keras-team/keras) | 55383 | Deep Learning for humans |
| [scikit-learn](https://github.com/scikit-learn/scikit-learn) | 50350 | scikit-learn: machine learning in Python |
| [caffe](https://github.com/BVLC/caffe) | 32675 | Caffe: a fast open framework for deep learning. |
| [gym](https://github.com/openai/gym) | 27746 | A toolkit for developing and comparing reinforcement learning algorithms. |
| [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) | 23174 | Data science Python notebooks: Deep learning (TensorFlow, Theano, Caffe, Keras), scikit-learn, Kaggle, big data (Spark, Hadoop MapReduce, HDFS), matplotlib, pandas, NumPy, SciPy, Python essentials, AWS, and various command lines. |
| [incubator-mxnet](https://github.com/apache/incubator-mxnet) | 19995 | Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Scala, Go, Javascript and more |
| [Paddle](https://github.com/PaddlePaddle/Paddle) | 18321 | PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice （『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署） |
...
| [deepdream](https://github.com/google/deepdream) | 13045 | None |
...
| [Machine-Learning-Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) | 12079 | machine learning and deep learning tutorials, articles and other resources  |
...
| [TensorLayer](https://github.com/tensorlayer/TensorLayer) | 7028 | Deep Learning and Reinforcement Learning Library for Scientists and Engineers  |
...
| [keras-js](https://github.com/transcranial/keras-js) | 4877 | Run Keras models in the browser, with GPU support using WebGL |
...
Last Automatic Update: Thu Jun  9 00:03:59 2022 (UTC)
