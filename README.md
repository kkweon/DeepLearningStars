...
| ---------- |:-----:| ----------- |
| [tensorflow](https://github.com/tensorflow/tensorflow) | 184602 | An Open Source Machine Learning Framework for Everyone |
| [pytorch](https://github.com/pytorch/pytorch) | 81138 | Tensors and Dynamic neural networks in Python with strong GPU acceleration |
| [keras](https://github.com/keras-team/keras) | 61439 | Deep Learning for humans |
| [scikit-learn](https://github.com/scikit-learn/scikit-learn) | 59130 | scikit-learn: machine learning in Python |
| [gym](https://github.com/openai/gym) | 34349 | A toolkit for developing and comparing reinforcement learning algorithms. |
| [caffe](https://github.com/BVLC/caffe) | 33998 | Caffe: a fast open framework for deep learning. |
| [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) | 26976 | Data science Python notebooks: Deep learning (TensorFlow, Theano, Caffe, Keras), scikit-learn, Kaggle, big data (Spark, Hadoop MapReduce, HDFS), matplotlib, pandas, NumPy, SciPy, Python essentials, AWS, and various command lines. |
| [Paddle](https://github.com/PaddlePaddle/Paddle) | 21960 | PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice （『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署） |
...
| [Machine-Learning-Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) | 15223 | machine learning and deep learning tutorials, articles and other resources  |
...
| [deepdream](https://github.com/google/deepdream) | 13238 | None |
| [playground](https://github.com/tensorflow/playground) | 11882 | Play with neural networks! |
| [char-rnn](https://github.com/karpathy/char-rnn) | 11542 | Multi-layer Recurrent Neural Networks (LSTM, GRU, RNN) for character-level language models in Torch |
| [convnetjs](https://github.com/karpathy/convnetjs) | 10841 | Deep Learning in Javascript. Train Convolutional Neural Networks (or ordinary ones) in your browser. |
...
| [TensorLayer](https://github.com/tensorlayer/TensorLayer) | 7311 | Deep Learning and Reinforcement Learning Library for Scientists and Engineers  |
...
| [TopDeepLearning](https://github.com/aymericdamien/TopDeepLearning) | 5848 | A list of popular github projects related to deep learning |
...
Last Automatic Update: Fri Aug  9 00:04:59 2024 (UTC)
