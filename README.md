...
| ---------- |:-----:| ----------- |
| [tensorflow](https://github.com/tensorflow/tensorflow) | 168906 | An Open Source Machine Learning Framework for Everyone |
| [pytorch](https://github.com/pytorch/pytorch) | 60093 | Tensors and Dynamic neural networks in Python with strong GPU acceleration |
| [keras](https://github.com/keras-team/keras) | 56539 | Deep Learning for humans |
| [scikit-learn](https://github.com/scikit-learn/scikit-learn) | 51983 | scikit-learn: machine learning in Python |
| [caffe](https://github.com/BVLC/caffe) | 32953 | Caffe: a fast open framework for deep learning. |
| [gym](https://github.com/openai/gym) | 28962 | A toolkit for developing and comparing reinforcement learning algorithms. |
| [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) | 24114 | Data science Python notebooks: Deep learning (TensorFlow, Theano, Caffe, Keras), scikit-learn, Kaggle, big data (Spark, Hadoop MapReduce, HDFS), matplotlib, pandas, NumPy, SciPy, Python essentials, AWS, and various command lines. |
...
| [playground](https://github.com/tensorflow/playground) | 10623 | Play with neural networks! |
| [convnetjs](https://github.com/karpathy/convnetjs) | 10414 | Deep Learning in Javascript. Train Convolutional Neural Networks (or ordinary ones) in your browser. |
...
| [tiny-dnn](https://github.com/tiny-dnn/tiny-dnn) | 5602 | header only, dependency-free deep learning framework in C++14 |
...
Last Automatic Update: Sun Nov  6 00:05:25 2022 (UTC)
