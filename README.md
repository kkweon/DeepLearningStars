...
| ---------- |:-----:| ----------- |
| [tensorflow](https://github.com/tensorflow/tensorflow) | 181658 | An Open Source Machine Learning Framework for Everyone |
| [pytorch](https://github.com/pytorch/pytorch) | 77101 | Tensors and Dynamic neural networks in Python with strong GPU acceleration |
| [keras](https://github.com/keras-team/keras) | 60787 | Deep Learning for humans |
| [scikit-learn](https://github.com/scikit-learn/scikit-learn) | 57839 | scikit-learn: machine learning in Python |
| [caffe](https://github.com/BVLC/caffe) | 33826 | Caffe: a fast open framework for deep learning. |
| [gym](https://github.com/openai/gym) | 33773 | A toolkit for developing and comparing reinforcement learning algorithms. |
| [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) | 26364 | Data science Python notebooks: Deep learning (TensorFlow, Theano, Caffe, Keras), scikit-learn, Kaggle, big data (Spark, Hadoop MapReduce, HDFS), matplotlib, pandas, NumPy, SciPy, Python essentials, AWS, and various command lines. |
| [Paddle](https://github.com/PaddlePaddle/Paddle) | 21532 | PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice （『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署） |
...
| [Machine-Learning-Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) | 14736 | machine learning and deep learning tutorials, articles and other resources  |
...
| [playground](https://github.com/tensorflow/playground) | 11618 | Play with neural networks! |
| [char-rnn](https://github.com/karpathy/char-rnn) | 11383 | Multi-layer Recurrent Neural Networks (LSTM, GRU, RNN) for character-level language models in Torch |
...
| [torch7](https://github.com/torch/torch7) | 8942 | http://torch.ch |
...
| [TensorLayer](https://github.com/tensorlayer/TensorLayer) | 7284 | Deep Learning and Reinforcement Learning Library for Scientists and Engineers  |
...
| [TopDeepLearning](https://github.com/aymericdamien/TopDeepLearning) | 5790 | A list of popular github projects related to deep learning |
...
Last Automatic Update: Mon Apr  1 00:04:51 2024 (UTC)
