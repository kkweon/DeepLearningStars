...
| ---------- |:-----:| ----------- |
| [tensorflow](https://github.com/tensorflow/tensorflow) | 161275 | An Open Source Machine Learning Framework for Everyone |
| [keras](https://github.com/keras-team/keras) | 53456 | Deep Learning for humans |
| [pytorch](https://github.com/pytorch/pytorch) | 52778 | Tensors and Dynamic neural networks in Python with strong GPU acceleration |
| [scikit-learn](https://github.com/scikit-learn/scikit-learn) | 48312 | scikit-learn: machine learning in Python |
| [caffe](https://github.com/BVLC/caffe) | 32149 | Caffe: a fast open framework for deep learning. |
| [gym](https://github.com/openai/gym) | 25973 | A toolkit for developing and comparing reinforcement learning algorithms. |
| [data-science-ipython-notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) | 22043 | Data science Python notebooks: Deep learning (TensorFlow, Theano, Caffe, Keras), scikit-learn, Kaggle, big data (Spark, Hadoop MapReduce, HDFS), matplotlib, pandas, NumPy, SciPy, Python essentials, AWS, and various command lines. |
| [incubator-mxnet](https://github.com/apache/incubator-mxnet) | 19796 | Lightweight, Portable, Flexible Distributed/Mobile Deep Learning with Dynamic, Mutation-aware Dataflow Dep Scheduler; for Python, R, Julia, Scala, Go, Javascript and more |
| [neural-style](https://github.com/jcjohnson/neural-style) | 18126 | Torch implementation of neural style algorithm |
| [Paddle](https://github.com/PaddlePaddle/Paddle) | 17228 | PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice （『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署） |
| [CNTK](https://github.com/microsoft/CNTK) | 17116 | Microsoft Cognitive Toolkit (CNTK), an open source deep-learning toolkit |
| [deepdream](https://github.com/google/deepdream) | 12953 | None |
| [Machine-Learning-Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials) | 11689 | machine learning and deep learning tutorials, articles and other resources  |
...
| [convnetjs](https://github.com/karpathy/convnetjs) | 10251 | Deep Learning in Javascript. Train Convolutional Neural Networks (or ordinary ones) in your browser. |
| [playground](https://github.com/tensorflow/playground) | 10127 | Play with neural networks! |
...
| [TensorLayer](https://github.com/tensorlayer/TensorLayer) | 6793 | Deep Learning and Reinforcement Learning Library for Scientists and Engineers 🔥 |
...
| [chainer](https://github.com/chainer/chainer) | 5652 | A flexible framework of neural networks for deep learning |
...
| [TopDeepLearning](https://github.com/aymericdamien/TopDeepLearning) | 5349 | A list of popular github projects related to deep learning |
...
| [DeepLearningZeroToAll](https://github.com/hunkim/DeepLearningZeroToAll) | 4238 | TensorFlow Basic Tutorial Labs |
...
| [DeepRL-Agents](https://github.com/awjuliani/DeepRL-Agents) | 2148 | A set of Deep Reinforcement Learning Agents implemented in Tensorflow. |
...
Last Automatic Update: Fri Dec 17 00:26:31 2021 (UTC)
